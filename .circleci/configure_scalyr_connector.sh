  ...
  cat << EOF > "$1"
{
  ...
  "config": {
    ...
    "tasks.max": "3",
    "topics": "logs",
    "custom_app_event_mapping":"[{\"matcher\": {\"attribute\": \"app\",\"value\": \"customApp\"}, \"eventMapping\": {\"id\":\"id\", \"app\":\"app\",\"serverHost\":\"hostname\",\"parser\":\"parser_name\",\"version\":\"metadata.@version\",\"forwarder\":\"forwarder\", \"timestamp\":\"@timestamp\", \"activity_type\":\"activity_type\", \"outcome\":\"outcome\", \"src_ip\":\"src_ip\", \"src_country\":\"src_country\", \"dest_ip\":\"dest_ip\", \"dest_country\":\"dest_country\", \"source_component\":\"source\", \"domain\":\"domain\", \"invalid_field\":\"invalid_field\", \"src_port\":\"src_port\", \"dest_port\":\"dest_port\", \"categories\":\"category.categories\", \"subcategory\":\"category.subcategory\", \"message\":\"message\", \"device_type\":\"device_type\", \"username\":\"username\", \"is_ransomware_src_ip\":\"threat.is_ransomware_src_ip\", \"is_ransomware_dest_ip\":\"threat.is_ransomware_dest_ip\", \"is_threat_src_ip\":\"threat.is_threat_src_ip\", \"is_threat_dest_ip\":\"threat.is_threat_dest_ip\", \"is_phishing_domain\":\"threat.is_phishing_domain\"}}, {\"matcher\": {\"attribute\": \"tag\",\"value\": \"fluentd-apache\"}, \"eventMapping\": {\"message\":\"log\", \"host\":\"host\", \"user\":\"user\",\"method\":\"method\",\"path\":\"path\",\"code\":\"code\",\"size\":\"size\",\"referer\":\"referer\",\"agent\":\"agent\",\"serverHost\":\"hostname\",\"container_id\":\"container_id\",\"container_name\":\"container_name\", \"tag\":\"tag\"}}, {\"matcher\": {\"attribute\": \"tag\",\"value\": \"fluentbit-cpu\"}, \"eventMapping\": {\"cpu_p\":\"cpu_p\", \"user_p\":\"user_p\", \"system_p\":\"system_p\",\"cpu0.p_cpu\":\"cpu0.p_cpu\",\"cpu0.p_user\":\"cpu0.p_user\", \"cpu0.p_system\":\"cpu0.p_system\",\"serverHost\":\"hostname\",\"timestamp\":\"@timestamp\",\"tag\":\"tag\"}, \"delimiter\":\"#\"}]",
EOF
